...
import numpy as np
# 加载数据
training_data = pd.read_csv(r'C:\Users\HP\Desktop\dino_testing features.csv')
training_labels = pd.read_csv(r'C:\Users\HP\Desktop\Datasets\b. IDRiD_Disease Grading_Testing Labels.csv')
